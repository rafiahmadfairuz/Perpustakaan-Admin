  ...
  <div class="col-md-12 mt-5">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="card-title mb-0">Data Penulis</h4>
      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          <input type="text" class="form-control" placeholder="Cari nama penulis..."
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              @empty
                <tr><td colspan="5" class="text-center">Tidak ada data penulis.</td></tr>
              @endforelse
            </tbody>
          </table>
        </div>
        <div class="mt-3">{{ $penulis->links() }}</div>
      </div>
    </div>
  </div>
        ...
        <div class="modal-body">
          <form wire:submit.prevent="store" id="createForm">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control @error('tahun') is-invalid @enderror" wire:model.defer="tahun">
              @error('tahun') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="mb-3">
              <label class="form-label">Tipe</label>
              <select class="form-select @error('tipe') is-invalid @enderror" wire:model.defer="tipe">
                <option value="">Pilih Tipe</option>
                <option value="Personal Name">Personal Name</option>
                <option value="Organization Body">Organization Body</option>
      ...
      <div class="modal-content rounded-3">
        ...
        <div class="modal-body">
          <form wire:submit.prevent="update" id="editForm">
            ...
            <div class="mb-3">
              <label class="form-label">Tahun</label>
              <input type="number" class="form-control" wire:model.defer="tahun">
            </div>
            <div class="mb-3">
              <label class="form-label">Tipe</label>
              <select class="form-select" wire:model.defer="tipe">
                <option value="">Pilih Tipe</option>
                <option value="Personal Name">Personal Name</option>
                <option value="Organization Body">Organization Body</option>
                <option value="Conference">Conference</option>
