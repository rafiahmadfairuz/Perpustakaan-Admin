        ...
        <div class="modal-body">
          <form id="createForm">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" placeholder="T001">
            </div>
            <div class="mb-3">
              <label class="form-label">Nama Tujuan</label>
              <input type="text" class="form-control" placeholder="Contoh: Perpustakaan Nasional">
            </div>
          </form>
        </div>
      ...
      <div class="modal-content rounded-3">
        ...
        <div class="modal-body">
          <form id="editForm">
            <div class="mb-3">
              <label class="form-label">Kode</label>
              <input type="text" class="form-control" value="T001">
            </div>
            <div class="mb-3">
              <label class="form-label">Nama Tujuan</label>
              <input type="text" class="form-control" value="Perpustakaan Nasional">
            </div>
          </form>
        </div>
        <div class="modal-footer">
