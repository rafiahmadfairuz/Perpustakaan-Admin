    ...
    <div class="col-md-12 mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Cari tanggal atau keterangan..."
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse($hariLiburs as $index => $hl)
                                <tr>
                                    <td>{{ $hariLiburs->firstItem() + $index }}</td>
                                    <td>{{ $hl->tanggal }}</td>
                                    <td>{{ $hl->keterangan }}</td>
                                    <td>
                                        <div class="d-flex gap-1">
                                            <button class="btn btn-outline-dark btn-sm" wire:click="editId({{ $hl->id }})" data-bs-toggle="modal" data-bs-target="#editModal">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <button class="btn btn-outline-danger btn-sm" wire:click="deleteId({{ $hl->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal">
                            ...
                            @empty
                                <tr><td colspan="4" class="text-center">Tidak ada data hari libur.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="store" id="createForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('keterangan') is-invalid @enderror" wire:model.defer="keterangan">
