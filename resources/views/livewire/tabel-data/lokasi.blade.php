  ...
  <div class="col-md-12 mt-5">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          <input type="text" class="form-control" placeholder="Cari kode atau nama lokasi..."
            ...
            <tbody>
              @forelse($lokasis as $index => $lokasi)
                <tr>
                  ...
                  <td>
                    <input type="checkbox" @if($lokasi->is_sgd) checked @endif disabled>
                  </td>
                  <td>
                    <div class="d-flex gap-1">
                      <button class="btn btn-outline-dark btn-sm" wire:click="editId({{ $lokasi->id }})" data-bs-toggle="modal" data-bs-target="#editModal">
                        <i class="fa fa-edit"></i>
                      </button>
                      <button class="btn btn-outline-danger btn-sm" wire:click="deleteId({{ $lokasi->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal">
        ...
        <div class="modal-body">
          <form wire:submit.prevent="store" id="createForm">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('kode_lokasi') is-invalid @enderror" wire:model.defer="kode_lokasi">
              @error('kode_lokasi')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="mb-3">
              <label class="form-label">Nama Lokasi</label>
              <input type="text" class="form-control @error('nama_lokasi') is-invalid @enderror" wire:model.defer="nama_lokasi">
              @error('nama_lokasi')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="form-check mb-3">
              <input type="checkbox" class="form-check-input" id="sgd" wire:model.defer="is_sgd">
      ...
      <div class="modal-content rounded-3">
        ...
        <div class="modal-body">
          <form wire:submit.prevent="update" id="editForm">
            <div class="mb-3">
              <label class="form-label">Kode</label>
              <input type="text" class="form-control" wire:model.defer="kode_lokasi">
            </div>
            <div class="mb-3">
              <label class="form-label">Nama Lokasi</label>
              <input type="text" class="form-control" wire:model.defer="nama_lokasi">
            </div>
            <div class="form-check mb-3">
              <input type="checkbox" class="form-check-input" id="editSgd" wire:model.defer="is_sgd">
