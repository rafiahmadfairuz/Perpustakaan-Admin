...
<div class="container-fluid">
    <div class="col-md-12 mt-5">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0">Konfigurasi Penomoran</h4>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse($penomorans as $index => $row)
                                <tr>
                                    <td>{{ $penomorans->firstItem() + $index }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <button class="btn btn-outline-dark btn-sm"
                                                wire:click="editId({{ $row->id }})" data-bs-toggle="modal"
                                                data-bs-target="#editModal">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <button class="btn btn-outline-danger btn-sm"
                                                wire:click="deleteId({{ $row->id }})" data-bs-toggle="modal"
                ...
                <div class="mt-3">{{ $penomorans->links() }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content rounded-3">
                <div class="modal-header" style="background:#141927; color:#fff;">
                    <h5 class="modal-title">Tambah Data Penomoran</h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="store" id="createForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_group') is-invalid @enderror"
                                wire:model.defer="kode_group">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_group') is-invalid @enderror"
                                wire:model.defer="nama_group">
                            @error('nama_group') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Counter</label>
                            <input type="number" class="form-control @error('konter') is-invalid @enderror"
                                wire:model.defer="konter">
                            @error('konter') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                    </form>
                </div>
    ...
    <div wire:ignore.self class="modal fade" id="editModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content rounded-3">
                <div class="modal-header" style="background:#141927; color:#fff;">
                    <h5 class="modal-title">Edit Data Penomoran</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form wire:submit.prevent="update" id="editForm">
                        <div class="mb-3">
                            <label class="form-label">Kode</label>
                            <input type="text" class="form-control" wire:model.defer="kode_group">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Group</label>
                            <input type="text" class="form-control" wire:model.defer="nama_group">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Counter</label>
                            <input type="number" class="form-control" wire:model.defer="konter">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
