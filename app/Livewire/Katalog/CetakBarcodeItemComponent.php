...
class CetakBarcodeItemComponent extends Component
{
    use WithPagination;
    ...
    $pdf = Pdf::loadView('livewire.pdf.cetak-barcode-pdf', [
        'item' => $item
    ...
    public function render()
    {
        ...
        $query->where('kode_item', 'like', '%' . $this->search . '%')
            ...
            ->latest()
            ->paginate(10);
        return view('livewire.katalog.cetak-barcode-item-component', compact('items'));
    }
}
